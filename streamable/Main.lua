...
-- // Silent Aim Module
local SilentAim = loadstring(game:HttpGet("https://raw.githubusercontent.com/loi31/cracked/main/streamable/Module.lua"))()
...
-- // Revert
setreadonly(mt, true)
getgenv().ValiantAimHacks.FOV = getgenv().StreamableFov
